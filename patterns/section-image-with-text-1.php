...
return array(
	...
	'content'    => '<!-- wp:media-text {"mediaPosition":"right","mediaId":2812,"mediaLink":"' . esc_url( get_stylesheet_directory_uri() . '/assets/images/meditatators.jpg' ) . '","mediaType":"image","mediaSizeSlug":"full","verticalAlignment":"center","imageFill":false,"backgroundColor":"foreground","textColor":"background","className":"is-style-default"} -->
