...
return array(
	'title'      => __( 'Image with text 1.', 'shambhala-twentytwentytwo' ),
	'categories' => array( 'sh-section' ),
	'content'    => '<!-- wp:media-text {"mediaPosition":"right","mediaId":2812,"mediaLink":"https://raw.githubusercontent.com/perky-design/shambhala-nl-twentytwentytwo-images/main/meditatators.jpg","mediaType":"image","mediaSizeSlug":"full","verticalAlignment":"center","imageFill":false,"backgroundColor":"foreground","textColor":"background","className":"is-style-default"} -->
	<div class="wp-block-media-text alignwide has-media-on-the-right is-stacked-on-mobile is-vertically-aligned-center is-style-default has-background-color has-foreground-background-color has-text-color has-background"><figure class="wp-block-media-text__media"><img src="https://raw.githubusercontent.com/perky-design/shambhala-nl-twentytwentytwo-images/main/meditatators.jpg" alt="' . esc_html__( 'Meditators', 'shambhala-twentytwentytwo' ) . '" class="wp-image-2812 size-full"/></figure><div class="wp-block-media-text__content"><!-- wp:heading {"textColor":"background","fontSize":"x-large"} -->
