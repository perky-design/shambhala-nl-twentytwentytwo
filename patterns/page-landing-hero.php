...
return array(
	...
	'content'    => '<!-- wp:cover {"url":"https://raw.githubusercontent.com/perky-design/shambhala-nl-twentytwentytwo-images/main/meditator-under-tree.jpg","id":2145,"dimRatio":15,"overlayColor":"secondary","focalPoint":{"x":"0.51","y":"0.27"},"minHeight":800,"minHeightUnit":"px","isDark":false,"align":"full","className":"cover-image-with-text"} -->
		...
		<h1 class="has-background-color has-text-color">Shambhala: a global community</h1>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"textColor":"background","className":"has-text-align-left has-text-color has-lead-font-size"} -->
		<p class="has-text-align-left has-text-color has-lead-font-size has-background-color">Shambhala is a global community of people inspired by the principle that every human being has a fundamental nature of basic goodness.</p>
		<!-- /wp:paragraph --></div>
		<!-- /wp:group --></div>
		<!-- /wp:column --></div>
		<!-- /wp:columns --></div></div>
