...
return array(
	...
	<!-- wp:column -->
	<div class="wp-block-column"><!-- wp:cover {"url":"http://shnl-wakkerisme.localhost/wp-content/themes/shambhala-nl-twentytwentytwo/assets/images/miksang-1.jpg","id":2709,"dimRatio":20,"overlayColor":"accent-color","focalPoint":{"x":"0.35","y":"0.89"},"minHeight":791,"minHeightUnit":"px"} -->
	<div class="wp-block-cover" style="min-height:791px"><span aria-hidden="true" class="wp-block-cover__background has-accent-color-background-color has-background-dim-20 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-2709" alt="" src="http://shnl-wakkerisme.localhost/wp-content/themes/shambhala-nl-twentytwentytwo/assets/images/miksang-1.jpg" style="object-position:35% 89%" data-object-fit="cover" data-object-position="35% 89%"/><div class="wp-block-cover__inner-container"><!-- wp:quote -->
	...
	<div class="wp-block-media-text alignwide is-stacked-on-mobile is-vertically-aligned-center rounded-image is-style-rounded-image width-full-size center-block" style="grid-template-columns:33% auto"><figure class="wp-block-media-text__media"><img src="' . esc_url( get_theme_file_uri( '/assets/images/buddha-statue-circle.jpg' ) ) . '" alt="Buddha statue" class="wp-image-2901 size-full"/></figure><div class="wp-block-media-text__content"><!-- wp:heading {"className":"is-style-heading-capitalized"} -->
	<h2 class="is-style-heading-capitalized">Welcome</h2>
	<!-- /wp:heading -->

	<!-- wp:heading {"textAlign":"left","level":3,"style":{"color":{"text":"#000000"}},"fontSize":"x-large"} -->
	<h3 class="has-text-align-left has-text-color has-x-large-font-size" style="color:#000000">Shambhala brings together people of all ages and from all walks of life</h3>
	<!-- /wp:heading -->

	<!-- wp:paragraph -->
	<p>Shambhala is based on trust in human dignity. We offer a path of meditation practice and contemplative arts oriented towards modern life.</p>
	<!-- /wp:paragraph -->
	...
	<h2 class="is-style-heading-capitalized has-primary-color has-text-color" style="text-transform:uppercase">Latest news</h2>
	<!-- /wp:heading --></div>
	<!-- /wp:column -->
	...
	<p class="has-text-align-right is-style-heading-capitalized link-no-underline has-tertiary-color has-text-color has-small-font-size"><a href="http://shnl-wakkerisme.localhost/nieuws/">All news &gt;</a></p>
	<!-- /wp:paragraph --></div>
	<!-- /wp:column --></div>
	<!-- /wp:columns -->
	...
	<div class="wp-block-columns"><!-- wp:column {"width":"66%"} -->
	<div class="wp-block-column" style="flex-basis:66%"><!-- wp:heading {"style":{"typography":{"textTransform":"uppercase"}},"textColor":"primary","className":"is-style-heading-capitalized"} -->
	<h2 class="is-style-heading-capitalized has-primary-color has-text-color" style="text-transform:uppercase">Upcoming events</h2>
	<!-- /wp:heading --></div>
	<!-- /wp:column -->

	<!-- wp:column -->
	<div class="wp-block-column"><!-- wp:paragraph {"align":"right","textColor":"tertiary","className":"is-style-heading-capitalized link-no-underline","fontSize":"small"} -->
	<p class="has-text-align-right is-style-heading-capitalized link-no-underline has-tertiary-color has-text-color has-small-font-size"><a href="#">All events &gt;</a></p>
	<!-- /wp:paragraph --></div>
	<!-- /wp:column --></div>
	<!-- /wp:columns -->
