<?php
/**
 * Title: Section with text (3 columns)
 * Slug: shambhala-twentytwentytwo/section-three-columns
 *
 * @package Shambhala Twenty Twenty-Two
 */

return array(
	'title'      => __( 'Three columns with images and text.', 'shambhala-twentytwentytwo' ),
	'categories' => array( 'sh-section' ),
	'content'    => '<!-- wp:heading {"align":"wide","fontSize":"x-large"} -->
