...
return array(
	'title'      => __( 'Meet the team section', 'shambhala-twentytwentytwo' ),
	'categories' => array( 'sh-section' ),
	'content'    => '<!-- wp:group {"align":"wide"} -->
<div class="wp-block-group alignwide"><!-- wp:heading {"fontSize":"x-large"} -->
<h2 class="has-x-large-font-size">' . esc_html__( 'Board of Directors', 'shambhala-twentytwentytwo' ) . '</h2>
<!-- /wp:heading -->
...
<h3 class="has-large-font-size">Gary Johnson</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"fontSize":"large"} -->
<h3 class="has-large-font-size">Lauren Morgan</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"fontSize":"large"} -->
<h3 class="has-large-font-size">Renee Olson</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"fontSize":"large"} -->
<h3 class="has-large-font-size">Linda Kelley</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"fontSize":"large"} -->
<h3 class="has-large-font-size">John Mullins</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"fontSize":"large"} -->
<h3 class="has-large-font-size">Kristin Conley</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"fontSize":"large"} -->
<h3 class="has-large-font-size">Jessica Hale</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"fontSize":"large"} -->
<h3 class="has-large-font-size">Tiffany Moore MD</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"fontSize":"large"} -->
<h3 class="has-large-font-size">Larry Glass</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"fontSize":"large"} -->
<h3 class="has-large-font-size">Ian Araújo</h3>
<!-- /wp:heading -->
