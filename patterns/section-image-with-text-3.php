<?php
/**
 * Title: Section with text (variant 3)
 * Slug: shambhala-twentytwentytwo/section-image-with-text-3
 *
...
return array(
	...
	<div class="wp-block-media-text alignwide is-stacked-on-mobile is-vertically-aligned-center width-full-size center-block" style="grid-template-columns:33% auto"><figure class="wp-block-media-text__media"><img src="https://raw.githubusercontent.com/perky-design/shambhala-nl-twentytwentytwo-images/main/meditators-illustration.png" alt="' . esc_html__( 'Illustration with four smiling meditators', 'shambhala-twentytwentytwo' ) . '" class="wp-image-3442 size-full"/></figure><div class="wp-block-media-text__content"><!-- wp:heading {"textAlign":"left","style":{"color":{"text":"#000000"}},"fontSize":"x-large"} -->
